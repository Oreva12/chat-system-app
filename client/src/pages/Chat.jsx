...
const TypingIndicator = ({ typers }) => {
  ...
  return (
    <div style={{
      ...
      padding: "4px 0 8px", minHeight: "24px",
    }}>
      {/* Animated dots */}
...
const Chat = () => {
  ...
  // Fire typing events on input change
  const handleMsgInput = (e) => {
  setMsgBody(e.target.value);
  console.log("🟢 typing in room:", activeRoom?._id); // ADD
  if (activeRoom && e.target.value.trim()) {
  ...
  // Get typers for active room excluding self
